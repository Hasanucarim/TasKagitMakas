...
public class RationalNumber implements Comparable<RationalNumber> {
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            RationalNumber nesne = (RationalNumber)obj;
    ...
    public void enterNumbers() {
        ...
        RationalNumber fraction = new RationalNumber(this.share, this.denominator);
    ...
    public void sortedList(List<RationalNumber> list) {
        List<RationalNumber> sortedList = new ArrayList();

        for(int i = 0; i < list.size(); ++i) {
            sortedList.add(i, (RationalNumber)list.get(i));
        }
    ...
    public RationalNumber add(RationalNumber number) {
        ...
        RationalNumber result = new RationalNumber(newShare, newDeminator);
        this.rationalNumbers.add(result);
        return result;
    }

    public RationalNumber substract(RationalNumber cikarilacakSayi) {
                ...
                while(goOn) {
                    if (this.rationalNumbers.size() >= 2) {
                        ...
                        if (number <= this.rationalNumbers.size() && number2 <= this.rationalNumbers.size()) {
                            ...
                            switch(i) {
                                case 1:
                                    RationalNumber addition = ((RationalNumber)this.rationalNumbers.get(this.firstRNumber)).add((RationalNumber)this.rationalNumbers.get(this.secondRNumber));
                                    System.out.println("Result:" + addition);
                                    break;
                                case 2:
                                    RationalNumber substraction = ((RationalNumber)this.rationalNumbers.get(this.firstRNumber)).substract((RationalNumber)this.rationalNumbers.get(this.secondRNumber));
                                    System.out.println("Result:" + substraction);
                                    break;
                                case 3:
                                    RationalNumber multiplication = ((RationalNumber)this.rationalNumbers.get(this.firstRNumber)).multiply((RationalNumber)this.rationalNumbers.get(this.secondRNumber));
                                    System.out.println("Result:" + multiplication);
                                    break;
                                case 4:
                                    RationalNumber division = ((RationalNumber)this.rationalNumbers.get(this.firstRNumber)).divide((RationalNumber)this.rationalNumbers.get(this.secondRNumber));
        ...
        while(goON) {
            ...
            while(goON) {
                ...
                switch(this.scan.nextInt()) {
                    ...
                    case 4:
                        RationalNumber obje = new RationalNumber(2, 4);
                        RationalNumber obje2 = new RationalNumber(3, 4);
                    ...
                    case 6:
                        if (this.rationalNumbers.size() >= 2) {
                            ...
                            System.out.println(((RationalNumber)this.rationalNumbers.get(first)).equals(this.rationalNumbers.get(second)));
                        } else {
